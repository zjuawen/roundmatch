...
// 检查头像 URL（公开接口，小程序使用）
router.get("/api/media/check-avatar", media.checkAvatar)
// 检查头像 URL（管理台，需要认证）
...
router.get("/api/admin/matches/:id/ranking", admins.verifyToken, matches.getRanking)
router.get("/api/admin/matches/:id/qrcode", admins.verifyToken, matches.getQRCode)
